...
extension OrdersVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.configureCell(number: order.orderTitle, description: order.description , memberCount: order.memberCount, addressFrom: order.fromAddress, addressTo:  order.toAddress)
        return cell
    }
